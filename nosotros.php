    ...
    <main>
        ...
        <div class="servicio">
            <div class="servicio-texto">
                <h2>Somos importadores directos</h2>
                <p>Brindamos servicio tecnico, repuestos y accesorios.
						 Contamos con personal altamente capacitados con mas de 7 años de experiencia.              
                </p>
                
                <div class="precio">
                    <span>Te brindamos envios a nivel nacional</span>
                </div>
            </div>
            <div class="servicio-imagen">
                <img src="img/bici.jpg" alt="Servicio ABC Express">
            </div>
        </div>
    </div>
