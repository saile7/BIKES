    ...
    <main>
        <form action="admin.php" method="post" enctype="multipart/form-data">
            ...
            <select id="categoria" name="categoria" required>
                ...
                <option value="Shimano_105">Shimano_105</option>
                <option value="Shimano_XTR">Shimano_XTR</option>
                <option value="Shimano_XT">Shimano_XT</option>
                <option value="Shimano_SLX">Shimano_SLX</option>
                <option value="Shimano_Deore">Shimano_Deore</option>
                <option value="Shimano_Claris">Shimano_Claris</option>
                <option value="Shimano_Cues">Shimano_Cues</option>
                <option value="Shimano_Alivio">Shimano_Alivio</option>
                <option value="Shimano_Tiagra">Shimano_Tiagra</option>
